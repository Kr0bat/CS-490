        ...
        <div class="col-12" id="<?php echo $info['id'] ?>" style="margin: 2ch 0 1ch 0">
            <div class="col-10 push-1 titleBold" id="post_container_<?php echo $info[id]?>" style="">
                ...
                <div class="col-12">
                    ...
                    <div class="col-10 bodyLight commentContainer comment_input_box_<?php echo $info['id'] ?>" id="" style="margin: 0; padding: 0.5ch 1ch 0.5ch 1ch; <?php if ($commentIndex == count($info["comments"])-1) { echo "border-radius: 0;"; } else { echo "border-radius: 0;"; } ?> font-style: normal; font-size: 18px;"> 
                        <table class="bodyLight">
                            <tbody>
                                <tr>
                                    <td style="max-width: fit-content;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="max-width: fit-content; width: 2.5ch;">
                                        ...
                                        <span class="">
                                            <img src="" class="" title="Delete Comment" style="height: 2.5ch; width: 2.5ch; margin-top: 0.25ch; content: url('data:image/svg+xml;base64,');">
                                        </span>
