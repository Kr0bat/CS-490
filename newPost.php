...
<body style="background-color: #161616; font-family: 'Montserrat', sans-serif;">
    ...
    <div class="col-8 push-2 colsm-12 pushsm-0 bodyLight newPostBackBox" style="text-align: left; margin-top: 3ch;">
        <form method="POST">
            ...
            <div class="col-10 push-1" style="margin: 0.25ch 0 2ch 0;">
            ...
            <div class="col-10 push-1" style="margin: 0.25ch 0 2ch 0;">
                <input maxlength="100" type="text" name="newpost_album_cover" placeholder="Paste link to alternate album cover here (optional)" value="" style="width: 100%; background-color: #000; border-color: #090909; border-style: solid; color: #fff; padding: 1vh 1vw; border-radius: 0.75ch; font-size: 20px;" optional />
            </div>
